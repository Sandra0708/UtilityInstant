...
export async function generateMetadata({params}:{params:Promise<{locale:Locale}>}){const {locale}=await params;return {title:locale==='en'?'UtilityInstant · Tools for your everyday':'UtilityInstant · Herramientas para tu día a día',description:locale==='en'?'Free calculators, converters and text tools. Understand, compare and export your results.':'Calculadoras, conversores y herramientas de texto gratis. Entiende, compara y exporta tus resultados.',alternates:alternate(locale)};}
