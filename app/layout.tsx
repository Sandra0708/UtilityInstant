...
export const metadata: Metadata = {title:'Nexo · Herramientas para tu día a día',description:'Calcula, convierte y entiende tus resultados. Herramientas gratuitas que funcionan en tu dispositivo.',icons:{icon:'/favicon.svg'},robots:{index:false,follow:true},other:{'google-adsense-account':adsensePublisher}};
